      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="bg-slate-50 border border-slate-200/80 rounded-lg p-3 space-y-1">
          ...
          <div className="flex items-center gap-2 pt-0.5">
            <span className="text-sm font-bold text-slate-500">{prevRiskPercent}%</span>
        ...
        <div className="bg-slate-50 border border-slate-200/80 rounded-lg p-3 space-y-1">
          ...
          <div className="flex items-center gap-2 pt-0.5">
            <span className="text-sm font-bold text-slate-500">{prevPest}</span>
            <ArrowRight className="w-3 h-3 text-slate-400 shrink-0" />
            <span className="text-base font-extrabold text-slate-900">{currPest}</span>
            <span
              className={`text-[11px] font-bold ml-auto ${
        ...
        <div className="bg-slate-50 border border-slate-200/80 rounded-lg p-3 space-y-1">
          ...
          <div className="flex items-center gap-1.5 text-xs font-bold text-slate-900 pt-0.5">
            <span>{prevHumidity}% RH</span>
            <ArrowRight className="w-3 h-3 text-slate-400 shrink-0" />
            <span className="text-sky-700">{currHumidity}% RH</span>
